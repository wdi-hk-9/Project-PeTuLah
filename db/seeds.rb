...
", language: "English", duration: 240, price: 600, image: "templerepulsebay.jpg"})
Tour.create({name: "Victoria Peak to South side Hike", description: "After crossing the spectacular and vibrant business district, we ride the Peak Tram (funicular railway) to commence our walk to the scenic, quieter side of Hong Kong.", language: "English", duration: 240, price: 600, image: "DSC01040.jpg"})
